...
module.exports = grammar({
    ...
    rules: {
      ...
      receiver: $ => prec(PREC.receiver, seq(
        '(',
        field('name', $.identifier),
        field('type', $._type),
        ')'
      ...
      closure_type: $ => prec.right(seq(
        'fun',
        field('reference', optional(choice("&", "&mut"))),
        choice(
          field('context', seq('{', '}')),
          field('type_context', $.generic_type),
        ),
        '.',
        field('parameters', $.parameter_list),
        field('result', optional(
      ...
      generic_type_param: $ => seq(
        field('type', $.identifier),
        field('type_arguments', $.type_params),
      ),

      _type_param: $ => prec(PREC.type_param, choice(
        $.identifier,
        $.generic_type_param
      )),
      ...
      type_params: $ => seq(
        '<',
        commaSeparatedList1(field('type', $._type_param)),
        '>'
      ),
      ...
      function_call: $ => prec.left(PREC.primary,
        seq(
          ...
          choice(
            seq(
              field('closure', choice($.block, $.closure_expression))
            ),
            seq(
              field('arguments', $.argument_list),
      ...
      pipe_expression: $ => prec.right(seq(
        field('left', $._expression),
        '|>',
        field('right', $._expression),
      )),

      err_pipe_expression: $ => prec.right(seq(
        field('left', $._expression),
        '|?>',
        field('right', $._expression)
      )),
